...
int main()
{
  ...
  do
  {
    ...
    std::cout << "5. Display a book" << std::endl;
    std::cout << "6. Display a member" << std::endl;
    std::cout << "7. Remove a book" << std::endl;
    std::cout << "8. Remove a member" << std::endl;
    std::cout << "9. Borrow a book" << std::endl;
    std::cout << "10. Return a book" << std::endl;
